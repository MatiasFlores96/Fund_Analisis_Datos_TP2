...
```{r}
ARIMA <- arima(entrenamiento_john, order = c(13,1,4), method = "ML")
...
```{r}
ARIMA_Nuestro <- arima(entrenamiento_john, order = c(16,1,5), method = "ML")
...
```{r}
accuracy(predARIMA, prueba_john_2)
accuracy(pred_autoARIMA, prueba_john_2)
accuracy(pred_ARIMANuestro, prueba_john_2)
```
